...
<!--Mas Informacion-->
<div class="modal" id="InfoVentanas">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="col-md-12">               
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header" style="background:#343a40;">
                  <h3 class="card-title">Registro ventanas</h3>
                  <div class="card-body">
                    <div class="chart-container" style="position: relative;">
                      <canvas id="GrafTemp" class="chartjs-render-monitor"></canvas>
                    </div>  
...
<!--Mas Informacion-->
<div class="modal" id="InfoTemperatura">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="col-md-12">               
            <div class="col-md-8">
              <div class="card card-primary">
                <div class="card-header" style="background:#343a40;">
                  <h3 class="card-title">Registro de temperatura</h3>
                <div class="card-body">
                  <div class="chart-container" style="position: relative;">
                    <canvas id="GrafTemp" class="chartjs-render-monitor"></canvas>
                  </div>  
...
<!--Mas Informacion-->
<div class="modal" id="InfoServicio">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
...
<!--Mas Informacion-->
<div class="modal" id="InfoIluminacion">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
